...
typedef enum {
    ...
    PHOTO_RESOLUTION_960P = 2,  // 1280x960
    PHOTO_RESOLUTION_1080P = 3, // 1920x1080
...
#define PHOTO_WIDTH_960P    1280
#define PHOTO_HEIGHT_960P   960
...
/* Default shared photo buffer size (1280x960 max) */
#define SHARED_PHOTO_BUF_WIDTH   PHOTO_WIDTH_960P
#define SHARED_PHOTO_BUF_HEIGHT  PHOTO_HEIGHT_960P
 ...
 *
 * @param buf Pointer to store buffer address
 * @param size Pointer to store buffer size (1280x960 max RGB565 format)
 */
