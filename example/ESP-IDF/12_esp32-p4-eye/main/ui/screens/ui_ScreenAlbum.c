...
void ui_ScreenAlbum_screen_init(void)
{
    ...
    lv_obj_set_width(ui_ImageScreenAlbum, BSP_LCD_H_RES);
    lv_obj_set_height(ui_ImageScreenAlbum, BSP_LCD_V_RES);
    ...
    lv_obj_set_x(ui_ImageAlbumMenu, -UI_SCALE_X(20));
    lv_obj_set_y(ui_ImageAlbumMenu, -100);
    lv_obj_set_align(ui_ImageAlbumMenu, LV_ALIGN_RIGHT_MID);
    ...
    lv_obj_set_x(ui_ImageAlbumUp, -UI_SCALE_X(20));
    lv_obj_set_y(ui_ImageAlbumUp, UI_SCALE_Y(120));
    lv_obj_set_align(ui_ImageAlbumUp, LV_ALIGN_TOP_RIGHT);
    ...
    lv_obj_set_x(ui_ImageAlbumDown, -UI_SCALE_X(20));
    lv_obj_set_y(ui_ImageAlbumDown, UI_SCALE_Y(175));
    lv_obj_set_align(ui_ImageAlbumDown, LV_ALIGN_TOP_RIGHT);
    ...
    lv_obj_set_style_bg_color(ui_ButtonPanelImageScreenAlbumDeleteYES, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ButtonPanelImageScreenAlbumDeleteYES, LV_OPA_TRANSP, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_ButtonPanelImageScreenAlbumDeleteYES, LV_OPA_TRANSP, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_ButtonPanelImageScreenAlbumDeleteYES, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_set_style_bg_opa(ui_ButtonPanelImageScreenAlbumDeleteYES, 150, LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_set_style_border_opa(ui_ButtonPanelImageScreenAlbumDeleteYES, LV_OPA_TRANSP, LV_PART_MAIN | LV_STATE_FOCUSED);
    ...
    lv_obj_set_style_bg_color(ui_ButtonPanelImageScreenAlbumDeleteNO, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_ButtonPanelImageScreenAlbumDeleteNO, LV_OPA_TRANSP, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui_ButtonPanelImageScreenAlbumDeleteNO, LV_OPA_TRANSP, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_ButtonPanelImageScreenAlbumDeleteNO, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_set_style_bg_opa(ui_ButtonPanelImageScreenAlbumDeleteNO, 150, LV_PART_MAIN | LV_STATE_FOCUSED);
    lv_obj_set_style_border_opa(ui_ButtonPanelImageScreenAlbumDeleteNO, LV_OPA_TRANSP, LV_PART_MAIN | LV_STATE_FOCUSED);
    ...
    lv_obj_update_layout(ui_PanelAlbumPopupSDWarning);
    lv_obj_set_style_transform_pivot_x(ui_PanelAlbumPopupSDWarning, lv_obj_get_width(ui_PanelAlbumPopupSDWarning) / 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_transform_pivot_y(ui_PanelAlbumPopupSDWarning, lv_obj_get_height(ui_PanelAlbumPopupSDWarning) / 2, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_transform_angle(ui_PanelAlbumPopupSDWarning, 900, LV_PART_MAIN | LV_STATE_DEFAULT);
