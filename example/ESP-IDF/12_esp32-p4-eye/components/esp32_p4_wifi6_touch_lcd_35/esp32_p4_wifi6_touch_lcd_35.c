...
static const char *TAG = "ESP32_P4_35";
...
void bsp_get_i2c_bus_handle(i2c_master_bus_handle_t *i2c_bus_handle)
{
...
void bsp_sdcard_detect_init(void)
{
}
...
esp_err_t bsp_flashlight_set(bool on)
{
    (void)on;
    return ESP_OK;
}
...
#if defined(CONFIG_BSP_DISPLAY_LVGL_TASK_PRIORITY)
    cfg.lvgl_port_cfg.task_priority = CONFIG_BSP_DISPLAY_LVGL_TASK_PRIORITY;
#endif
#if defined(CONFIG_BSP_DISPLAY_LVGL_TICK)
    cfg.lvgl_port_cfg.timer_period_ms = CONFIG_BSP_DISPLAY_LVGL_TICK;
#endif
#if defined(CONFIG_BSP_DISPLAY_LVGL_MAX_SLEEP)
    cfg.lvgl_port_cfg.task_max_sleep_ms = CONFIG_BSP_DISPLAY_LVGL_MAX_SLEEP;
#endif
    cfg.lvgl_port_cfg.task_stack = 4096;
    cfg.lvgl_port_cfg.task_affinity = 0;
    cfg.buffer_size = BSP_LCD_DRAW_BUFF_SIZE;
    cfg.double_buffer = BSP_LCD_DRAW_BUFF_DOUBLE;
    cfg.flags.buff_dma = false;
...
void bsp_display_rotate(lv_disp_rot_t rotation)
{
...
void bsp_enter_sleep_init(void)
{
}

void bsp_display_del(void)
{
